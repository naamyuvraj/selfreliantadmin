      ...
      <div className="flex h-full flex-col">
        <div className="flex h-14 md:h-16 items-center border-b border-gray-700 px-4 md:px-6">
          <Link href="/" className="flex items-center gap-2 font-semibold text-white">
            ...
            <span className="text-base md:text-lg">Self Reliant Admin</span>
          </Link>
        </div>
        ...
        <div className="mt-auto p-2 md:p-4">
          <button
            ...
            className="w-full flex items-center justify-start px-3 py-2 text-sm text-gray-300 hover:text-[#C87355] border border-gray-700 hover:border-[#C87355] rounded-md"
          >
